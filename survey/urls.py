...
urlpatterns = [
    ...
    path('responses/survey/<uuid:uuid>/correlation', views.correlation_table, name='correlation_table'),
...
url_for_htmx = [
    ...
    path("surveys/<uuid:uuid>/toggle-status-confirm", views.ToggleSurveyStatusConfirm, name="ToggleSurveyStatusConfirm"),
]
